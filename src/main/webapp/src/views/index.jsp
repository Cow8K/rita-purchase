...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/src/layuiadmin/style/admin.css" media="all">
</head>
        ...
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-hide-xs" lay-unselect>
					<a href="https://www.layui.com/admin/" target="_blank" title="前台">
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all"
                    ...
                    <li data-name="home" class="layui-nav-item layui-nav-itemed">
                        <a href="javascript:void(0);" lay-tips="主页" lay-direction="2">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd data-name="console">
                                <a lay-href="${pageContext.request.contextPath }/src/views/results.jsp">成绩管理</a>
                            </dd>
                        </dl>
                    </li>
                </ul>
